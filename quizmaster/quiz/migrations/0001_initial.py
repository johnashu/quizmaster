# Generated by Django 2.0.2 on 2018-02-27 08:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colour', models.CharField(default='#99c24d', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='Quizzer',
            fields=[
                ...
                ('interests', models.ManyToManyField(related_name='interested_students', to='quiz.Topic')),
            ],
        ),
        migrations.AddField(
            model_name='quiz',
        ...
        migrations.AddField(
            ...
            name='quizzer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taken_quizzes', to='quiz.Quizzer'),
        ),
        migrations.AddField(
            model_name='quizzeranswer',
            name='quizzer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_answers', to='quiz.Quizzer'),
        ),
        migrations.AddField(
            model_name='quizzer',
            name='quizzes',
